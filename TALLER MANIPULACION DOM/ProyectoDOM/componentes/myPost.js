...
miniBannerOne(){    
    ...
    <strong class="d-inline-block mb-2 text-primary">${this.dataCardOne.strongTitle}</strong>
    <h3 class="mb-0">${this.dataCardOne.titleCard}</h3>
    <div class="mb-1 text-muted">${this.dataCardOne.subtitle}</div>
    <p class="card-text mb-auto">${this.dataCardOne.paragraph}</p>
    <a href="${this.dataCardOne.continueLink}" class="stretched-link">${this.dataCardOne.continue}</a>
    `)
...
miniBannerTwo(){
    ...
    <strong class="d-inline-block mb-2 text-primary">${this.dataCardTwo.strongTitle}</strong>
    <h3 class="mb-0">${this.dataCardTwo.titleCard}</h3>
    <div class="mb-1 text-muted">${this.dataCardTwo.subtitle}</div>
    <p class="card-text mb-auto">${this.dataCardTwo.paragraph}</p>
    <a href="${this.dataCardTwo.continueLink}" class="stretched-link">${this.dataCardTwo.continue}</a>
    `)
